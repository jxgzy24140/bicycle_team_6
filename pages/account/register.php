...
<body>
  ...
  if (isset($_POST['addBtn'])) {
    ...
    $uniqCheck = mysqli_query($conn, "SELECT Username FROM client WHERE Username = '$username'");
    if (mysqli_num_rows($uniqCheck) > 0) {
      ...
      if ($password != $rpassword) {
        ...
        $insert_run = mysqli_query($conn, "INSERT INTO client(TIN,Username,Password,NIN,Name,Address)
      VALUES('$tin','$username','$hash','$nin','$name','$address')");
                  ...
                  <form method="POST" class="mx-1 mx-md-4">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input value="<?php echo (isset($tin)) ? $tin : '' ?>" type="text" id="form3Example1c" class="form-control " name="tin" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <input value="<?php echo (isset($username)) ? $username : '' ?>" type="text" id="form3Example1c" class="form-control " name="username" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        <input value="<?php echo (isset($name)) ? $name : '' ?>" type="text" id="form3Example1c" class="form-control " name="name" />
